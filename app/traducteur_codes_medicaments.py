...
@app.cell
def _():
    """Traducteur de codes médicaments (CIS, CIP7, CIP13, DCI).
    ...
    Recherche approximative via rapidfuzz (tolérance aux fautes et accents).
    """
    import io
    import marimo as mo
    import pandas as pd
...
@app.cell
def _(fuzz, index_dci, index_denom, normaliser):
    def score_lexical(requete_norm: str, cle: str) -> float:
        if requete_norm in cle:
            return 1.0
        return fuzz.partial_ratio(requete_norm, cle) / 100.0
